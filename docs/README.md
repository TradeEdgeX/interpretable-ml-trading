...
| [横截面多因子能力](cs_panel_CN.md) · [EN](cs_panel.en.md) | `cs_panel` / `cs_sector` | 框架说明 | 已量句均 reject，不是推荐策略 |
...
| [AI 融资公告后做多 BTC](examples/20260914_ai_financing_btc_CN.md) · [EN](examples/20260914_ai_financing_btc.en.md) | Phase 1；2h 书未跑 | beta | IC −0.021；**不能 declare** |
