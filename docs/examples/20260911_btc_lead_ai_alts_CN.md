...
这句话量的是「BTC 先定价、主题盘后买」能不能在三段上都活下来。赢了原句还活着；任一段年化为负，或近窗回撤深于趋势段，原句死。哪一段山寨还没上市，就不能只靠后面两段过关。
...
你对本仓库说同一句。先分类：**beta**，山寨跟着比特币的冷热走，不是「会选哪一根」。模板锁死：进场只看**上一根已经收完**的比特币涨幅，对齐到山寨自己的那根棒上；不许看还没收完的当根，也不许换成「比特币最近九十根涨了多少」。哪一段山寨还没上市，就写「这段没有样本」，不能用别的币凑。你说测了，才下载、算出对齐好的领涨数字、按 2 小时进出场出表。
...
人出句（BTC 大涨后 AI 山寨跟涨）
  ...
  → 查过：以前有没有判过同一句
  → 人说「测一下」才下载成交、事先对齐好「比特币上一根涨了多少」
  → 按山寨自己的 2 小时棒：上一根比特币涨过 3% 就做多，拿 6 根
  → 人写下结不成立
```

这句按山寨自己的 2 小时棒进出场。比特币刚大涨多少，必须是山寨那根棒上已经对齐好、上一根就收完的数字。不要换成「比特币最近九十根涨了多少」，也不要在出表时现场另算一遍。
...
| 证伪 | 任一段年化 < 0，或近窗 MaxDD 深于趋势段。近窗不能单独过关。 |
