...
公开仓只留 court 软件、夹具、以及 README 里量过的两个例子。  
现网那两百多个变体树不在本目录。

| 目录 | 角色 |
|---|---|
| `_template/` | `mlbot research init` 的壳 |
...
主入口：[README_CN.md](../../README_CN.md)。谁写 `verdict`：[docs/agent/rd_playbook.md](../../docs/agent/rd_playbook.md)。
