...
- Long BTC after an AI financing print: [docs/examples/20260914_ai_financing_btc.en.md](docs/examples/20260914_ai_financing_btc.en.md) · [中文](docs/examples/20260914_ai_financing_btc_CN.md)
- Score the whole market every day, buy the hottest sleeve: [docs/cs_panel.en.md](docs/cs_panel.en.md) · [中文](docs/cs_panel_CN.md)
